...
# ============================================================
# VJ146A2 full-year selected-settlement pixel close-ups
# ============================================================
#
# Purpose: Render raw-pixel close-ups and satellite context tiles
#          for the original five VJ146A2 selected events plus the
#          additional full-year notebook candidates screened for
#          previous/event/next support and coverage.
# Output:  PNG panels plus event-window, full-year benchmark, and location CSVs.
# Run:     Rscript validation/closeups/scripts/vj146a2_full_year_selected_settlement_pixel_closeups.R
# ============================================================
...
if (length(script_arg) > 0) {
  ...
  SCRIPT_PATH <- normalizePath("validation/closeups/scripts/vj146a2_full_year_selected_settlement_pixel_closeups.R")
}
...
OUT_DIR <- file.path(
  paths$figures_dir,
  "generated",
  "vj146a2_full_year_selected_settlement_pixel_closeups"
)

dir.create(OUT_DIR, recursive = TRUE, showWarnings = FALSE)

OUT_METRICS <- file.path(OUT_DIR, "vj146a2_full_year_selected_settlement_event_window_metrics.csv")
OUT_ANALYSIS <- file.path(OUT_DIR, "vj146a2_full_year_selected_settlement_analysis_metrics.csv")
OUT_LOCATIONS <- file.path(OUT_DIR, "vj146a2_full_year_selected_settlement_locations.csv")
...
EVENTS <- tibble::tribble(
  ...
  "61851",        "2023-04-21",  "Thembisile Hani Local Municipality",    "strict dark",  "Additional large notebook candidate; prev/event/next p_lit 0.989 -> 0.000 -> 0.892, min 3-day coverage 0.969, obs days 244.",
  "48939",        "2023-09-13",  "Matjhabeng Local Municipality",         "strict dark",  "Additional large notebook candidate; prev/event/next p_lit 0.900 -> 0.028 -> 0.909, min 3-day coverage 1.000, obs days 240.",
  "70733",        "2023-07-12",  "Elias Motsoaledi Local Municipality",   "strict dark",  "Additional large notebook candidate; prev/event/next p_lit 0.869 -> 0.014 -> 0.904, min 3-day coverage 1.000, obs days 252.",
  "55160",        "2023-04-17",  "Moses Kotane Local Municipality",       "strict dark",  "Additional large notebook candidate; prev/event/next p_lit 0.743 -> 0.037 -> 0.815, min 3-day coverage 1.000, obs days 245.",
  "49044",        "2023-05-22",  "Moqhaka Local Municipality",            "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 1.000 -> 0.085 -> 1.000, min 3-day coverage 1.000, obs days 235.",
  "70495",        "2023-01-18",  "Dr JS Moroka Local Municipality",       "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.929 -> 0.092 -> 0.998, min 3-day coverage 0.991, obs days 239.",
  "52564",        "2023-01-22",  "Westonaria Local Municipality",         "strict dark",  "Additional large notebook candidate; prev/event/next p_lit 0.594 -> 0.038 -> 0.600, min 3-day coverage 1.000, obs days 243.",
  "51558",        "2023-07-12",  "Merafong City Local Municipality",      "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.935 -> 0.130 -> 0.941, min 3-day coverage 1.000, obs days 238.",
  "46678",        "2023-04-24",  "Ga-Segonyana Local Municipality",       "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.794 -> 0.164 -> 0.902, min 3-day coverage 1.000, obs days 272.",
  "63077",        "2023-10-06",  "Albert Luthuli Local Municipality",     "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.970 -> 0.142 -> 0.999, min 3-day coverage 0.887, obs days 183.",
  "61930",        "2023-07-12",  "Emalahleni Local Municipality",         "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.711 -> 0.090 -> 0.875, min 3-day coverage 0.873, obs days 242.",
  "70237",        "2023-01-22",  "Bela Bela Local Municipality",          "mostly dark",  "Additional large notebook candidate; prev/event/next p_lit 0.969 -> 0.198 -> 0.490, min 3-day coverage 1.000, obs days 254."
) %>%
...
render_event_panel <- function(event) {
  ...
  title(
    main = paste0(event$label, " full-year ", event$event_class, " event close-up"),
    outer = TRUE,
    cex.main = 1.35,
    line = 3.5
  )
...
message("Wrote full-year metrics: ", OUT_ANALYSIS)
