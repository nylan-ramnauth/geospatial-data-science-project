...
#           applies the coverage threshold filter, and writes filtered
#           panels for use in downstream reliability analysis.
# Inputs:   - Map Data/settlement_day_outputs_rasters_blackmarbler/settlement_day_blackmarbler_nocov_YYYY-MM.parquet
# Outputs:  - Map Data/settlement_day_outputs_rasters_blackmarbler/settlement_day_blackmarbler_cov_YYYY-MM.parquet
# Run:      Rscript Builder/settlement_day_coverage_filter.R
# ============================================================
...
for (mi in seq_along(months_seq)) {
  ...
  in_parq <- file.path(IN_DIR, paste0("settlement_day_blackmarbler_nocov_", m_str, ".parquet"))
  out_parq <- file.path(OUT_DIR, paste0("settlement_day_blackmarbler_cov_", m_str, ".parquet"))
